...
export default function TableLayout({ children, categories }: Props) {
  ...
  return (
    <div className="bg-white fixed left-[50%] -translate-x-1/2 w-full h-full">
      ...
      <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-full">
        ...
        <section aria-labelledby="products-heading" className="pb-24 pt-6  h-full">
          ...
          <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4 h-full">
            ...
            <div className="lg:col-span-3 max-h-full  overflow-auto px-4 pt-4 pb-20">{children}</div>
          </div>
        </section>
      </main>
    </div>
