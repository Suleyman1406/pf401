...
export const PostCard = ({ post }) => {
  const { id, image, content, tags, title, createdAt, author, likes } = post;
  ...
  const showPostAction = !!user && user.id === author.id;
  ...
  return (
    <div className="bg-white p-8 rounded-lg shadow-md max-w-md min-w-[400px]">
      <div className="flex items-center justify-between mb-4">
        ...
        {showPostAction && <PostCardAction post={post} />}
      </div>
      ...
      <div className="flex items-center justify-between text-gray-500">
        <PostLike likes={likes} postId={id} />
        <button
